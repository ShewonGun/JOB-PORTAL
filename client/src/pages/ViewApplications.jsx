...
const ViewApplications = () => {
  return (
    <div className='container mx-auto p-4'>
        <div>
            <table className='w-full border max-w-4xl bg-white border-gray-200 max-sm:text-sm'>
                <thead>
                    ...
                    {viewApplicationsPageData.map((applicant, index) => (
                        <tr key={index} className='text-gray-700'>
                            ...
                            <td className='py-2 px-4 border-b'>
                                ...
                                className='bg-blue-50 text-blue-400 px-3 py-1 rounded inline-flex items-center gap-2 cursor-pointer'>
