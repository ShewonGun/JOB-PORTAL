    ...
    <div className='container 2xl:px-20 mx-auto my-10 '>
        <div className='bg-gradient-to-r from-purple-800 to-purple-950 text-white py-16 text-center mx-2 rounded-xl'>
            ...
            <div className='flex items-center justify-between bg-white max-w-xl rounded text-gray-600 pl-4 mx-4 sm:mx-auto'>
                ...
                <button className='bg-blue-600 px-6 py-2 text-white m-1 rounded' onClick={onSearch}>Search</button>
            </div>
        </div>

        <div className='border brder-gray-300 shadow-md rounded-lg mt-5 mx-2 flex'>
            <div className='flex justify-center lh:gap-16 flex-wrap p-4 gap-10'>
